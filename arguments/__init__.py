...
class ModelParams(ParamGroup): 
    def __init__(self, parser, sentinel=False):
        self.sh_degree = 3
        self._source_path = ""
        self._model_path = "/data/hyliu/endonerf-output/"
        self._images = "images"
        self._resolution = -1
...
class ModelHiddenParams1(ParamGroup):
    def __init__(self, parser):
        self.net_width = 64
        self.timebase_pe = 4
        self.defor_depth = 1
        ...
        self.no_dr=False
        self.no_do=True
        super().__init__(parser, "ModelHiddenParams1")
